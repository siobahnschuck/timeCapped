                      ...
                      case 'img':
                        ...
                        return (<div className="imgReward"> <div> <img src={value} alt="poster" style={{height: 350, width: 350}} /> </div>
                          <div className="social">
                            ...
                            <FacebookIcon logoFillColor="white" round={true} style={{boxShadow: 'none'}}></FacebookIcon>
                            </FacebookShareButton>
                            <TwitterShareButton className="social-btn" title="Internet Capsule" via="http://localhost:3000/capsule" hashtags="[#React #NetArt]"><TwitterIcon logoFillColor="white" round={true}></TwitterIcon></TwitterShareButton>
                            <EmailShareButton className="social-btn" subject="Look at what I pulled from this Internet Time Capsule!"><EmailIcon logoFillColor="white" round={true}></EmailIcon></EmailShareButton> 
